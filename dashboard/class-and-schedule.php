						...
						<div class="card">
							<div class="card-header">
								<div class="card-head-row">
									<h4 class="card-title">Classes and Schedules</h4>
									...
									<table id="multi-filter-select1" class="display table table-striped table-hover" >
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>TTH</td>
                                                <td>7:30 - 8:30AM</td>
                                                <td>Ma'am Julie Dare Remolano</td>
                                            </tr>
										</tbody>
									</table>
								</div>
