    ...
    <div class="main-panel">
		<div class="content">
			<div class="page-inner">
                <div class="mt-2 mb-4">
					<h2 class="text-black pb-2">Class Schedule (<?= $year ?> - <?= $section ?>)</h2>
				</div>	
							...
							<div class="card-header">
								<div class="card-head-row">
                                    ...
                                    <h4 class=" h4">
                                        ...
                                        <b> Year & Section:</b> <?= $year?> - <?= $section?><br>
                                        <b> SY & Semester:</b> <?= $_SESSION['year_from']?>-<?= $_SESSION['year_to']?> <?= $_SESSION['semester']?><br>
                                        <b></b> 
                                    </h4>
													...
													<tr>
														...
														<td>
															...
															if($_SESSIO['role'] == 'admin' || $_SESSIO['role'] == 'staffs'){
																?>
																<div class="btn-group">
																	<button title="Edit" class="btn btn-warning btn-sm br-0" ><i class="fa fa-edit"></i></button>
																	<button title="Delete" class="btn btn-danger btn-sm br-0"><i class="fa fa-trash"></i></button>
																</div>
																<?php
															}
															?>
